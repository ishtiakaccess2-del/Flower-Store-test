  ...
  if (isFirebaseActive) {
    try {
      if (mode === 'register') {
        ...
        if (userDoc.exists) {
          ...
          // Force role mapping if matches target admin
          if (email === "admin@gmail.com") {
            userData.role = "admin";
          }
    ...
    if (mode === 'register') {
      ...
      if (email === "admin@gmail.com") {
        ...
        // Standard non-admin client login
...
/**
 * ==========================================================================
 * 5. ROUTING SYSTEM & NAVIGATION (SECURED GATES)
 * ==========================================================================
 */
function navigateTo(viewId) {
  // SECURE GATE: Block access to 'admin' page if the credentials do not match strictly
  if (viewId === "admin") {
...
/**
 * ==========================================================================
 * 14. ADMINISTRATIVE PORTAL CMS WORKSPACES
 * ==========================================================================
 */
...
/**
 * ==========================================================================
 * 16. BOOTSTRAP EVENT LISTENERS & HASH ROUTER GATES
 * ==========================================================================
 */
