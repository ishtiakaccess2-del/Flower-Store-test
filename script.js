...
// Attempt Firebase initialization if credentials are validly supplied
if (firebaseConfig.apiKey !== "") {
    try {
        ...
        console.error("Firebase connection error. Falling back to clean local operational mode.", err);
    }
} else {
    console.log("Operational mode: Local storage fallback mechanism active.");
}

// ==========================================
// ADMIN CONFIGURATION
// ==========================================
const ADMIN_EMAIL = "admin@golapcanon.com"; // আপনার এডমিন ইমেইল
...
const PRODUCTS = [
    ...
    {
        id: "prod_006",
        name: "Royal Hydrangeas Sphere",
        category: "bouquets",
        price: 75.00,
        oldPrice: 90.00,
        discount: 16,
        rating: 4.9,
        image: "https://images.unsplash.com/photo-1587334206501-3141f17fae42?auto=format&fit=crop&q=80&w=600",
        desc: "Huge spherical arrangement of deep blue and white imported hydrangeas designed as focal point vase pieces.",
        featured: false
    },
    {
        id: "prod_007",
        name: "Dusk Romance Gift Box",
        category: "gifts",
        price: 95.00,
        oldPrice: 120.00,
        discount: 20,
        ...
        desc: "Elegant luxury box featuring customized natural matching perfumes, organic scented candles, and preserved dark roses.",
        featured: false
    },
    {
        id: "prod_008",
        name: "Emerald Garden Stage Pillar",
        category: "wedding",
        price: 280.00,
        oldPrice: 340.00,
        discount: 17,
        ...
        desc: "Lush green styling pillars designed to support wedding altars or runway guidelines. Built from deep moss and luxury foliage.",
        featured: false
    }
];
...
const TESTIMONIALS = [
    {
        ...
        text: "Golap - Canon completely revolutionized our winter banquet layout. Their master florist transformed a sterile hall into a warm, gorgeous crimson paradise. Exquisite detail!",
        rating: 5
    },
    {
        name: "Nabila Rahman",
        role: "Luxury Bride",
        text: "I was stunned by the beauty of my Cascade Arch. Every single petal felt pristine. The convenience of their WhatsApp checkout gave me instant planner peace of mind.",
        rating: 5
    },
    {
        name: "Daniel Mercer",
        role: "Corporate Patron",
        text: "Exceptional speed. Ordered a premium gift hamper and bespoke jewelry box at 11 AM, and it arrived in immaculate condition before my evening banquet. Stellar service.",
        rating: 5
    }
];
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Maintain user visual state persistent upon reload
    if (userProfile) {
        updateUserDisplayState(userProfile);
    }
}); // ক্লোজিং ব্র্যাকেট ও প্যারেন্থেসিস এখন ঠিক আছে
...
function initAppComponents() {
    ...
    // Mobile search display triggers
    ...
    // Real-time search query update handlers
    ...
    // Setup FAQ items collapsible accordions
    ...
    // Setup CTA hooks on event styling segments
    ...
    contactForm.addEventListener("submit", async (e) => {
        ...
        if (isFirebaseActive) {
            ...
            showToast("Details preserved locally. A stylist will reach you via WhatsApp shortly.", "success");
        }
        contactForm.reset();
    });
    ...
    // Quick View counter increment controls
    let activeQvQty = 1;
    ...
    // Quick view add-to-cart linkage
    ...
    // Quick view direct WhatsApp order placement linkage
    ...
    // WhatsApp Checkout Form Submission Handler
    ...
    // Initialise slider gesture interactions
...
function initTrendingSliderDragSupport() {
    ...
    // Infinite autoplay transition loop
