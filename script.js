...
async function switchAdminTabWorkspace(tab) {
    ...
    // Fetch collections from Firestore or local storage fallbacks [3]
    if (isFirebaseActive) {
        try {
    ...
    if (tab === "dashboard") {
                    ...
                    <form id="admin-add-product-form" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="adm-p-price" required class="w-full bg-surface border border-white/10 rounded-lg p-2.5 text-xs focus:ring-1 focus:ring-primary outline-none text-on-surface" type="number" step="0.01" placeholder="45"/>
                            </div>
                            <div>
                        ...
                        <div class="p-4 bg-surface border border-white/5 rounded-lg space-y-2">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-[10px] text-on-variant/70 font-medium">Recipient Phone: ${o.customerPhone} | Target Delivery: ${o.deliveryDate}</p>
                                </div>
        ...
        // Banner Content Form submission
