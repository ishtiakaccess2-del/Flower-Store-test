...
/**
 * ==========================================================================
 * 5. ROUTING SYSTEM & NAVIGATION (SECURED GATES WITH AUTO HASH SYNC)
 * ==========================================================================
 */
function navigateTo(viewId) {
  if (viewId === "admin") {
    const isAuthenticAdmin = state.currentUser && 
                             state.currentUser.role === "admin" && 
                             state.currentUser.email === "admin@gmail.com";
    if (!isAuthenticAdmin) {
      showToast("অনাধিকার প্রবেশ! অনুগ্রহ করে অ্যাডমিন অ্যাকাউন্ট দিয়ে লগইন করুন।", "danger");
      window.location.hash = "#auth";
      return;
    }
    // Force CMS tab loading and real-time dashboard render when entering admin page
...
/**
 * ==========================================================================
 * 14. MODAL ASSISTANCE & MOBILE DRAWER FUNCTIONS
 * ==========================================================================
 */
...
/**
 * ==========================================================================
 * 17. BOOTSTRAP EVENT LISTENERS & HASH ROUTER GATES
 * ==========================================================================
 */
window.addEventListener("DOMContentLoaded", async () => {
  ...
  // Programmatically attach click interceptors to Profile/Account buttons
  // This completely fixes hash mismatches and redirection loops
  const desktopProfileBtn = document.getElementById("user-profile-btn");
  if (desktopProfileBtn) {
    desktopProfileBtn.removeAttribute("onclick");
  ...
  const mobileProfileBtn = document.getElementById("mobile-tab-auth");
  if (mobileProfileBtn) {
    mobileProfileBtn.removeAttribute("onclick");
